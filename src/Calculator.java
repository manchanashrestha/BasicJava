...
public class Calculator {
	...
	public void calculation() {
		...
		if (operatorType.equals("+")) {
			...
			System.out.println(" Addition of two number  " + firstNumber + " and " + secondNumber + " is "
			...
			if (firstInteger > secondInteger) {
				System.out.println(" Subtraction of two number  " + firstNumber + " and " + secondNumber + " is "
						+ (firstInteger - secondInteger));
			} else {
			...
			if (firstInteger > secondInteger) {
				...
				System.out.println(" Division of two number  " + firstNumber + " and " + secondNumber + " is "
						+ (firstInteger / secondInteger));
			} else {
				System.out.println("First number should be greater than second number");
			}
			...
			Integer firstInteger = Integer.parseInt(firstNumber);
			Integer secondInteger = Integer.parseInt(secondNumber);
			System.out.println(" Multiplication of two number  " + firstNumber + " and " + secondNumber + " is "
					+ (firstInteger * secondInteger));
		} else {
